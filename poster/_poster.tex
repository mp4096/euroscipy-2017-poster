...
\begin{tikzpicture}[
  ...
  \node[
    ...
    at (50, 45) {\textsf{\input{second_column_indentex}}};
  ...
  \node[
    ...
    at (7, 90) {\textsf{\input{third_column_indentex}}};


  \begin{scope}[xshift = 10 cm, yshift = -60 cm]
    \input{flat_to_structure}
  \end{scope}

  \begin{scope}[xshift = 40 cm, yshift = -20 cm]
