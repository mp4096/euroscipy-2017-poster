...
\begin{tikzpicture}[
  ...
  % \draw[black!40] (0, 8) -- +(84.1, 0) node[midway, above, black!80] {\Huge{}8};
  % \draw[black!40] (0, 37) -- +(84.1, 0) node[midway, above, black!80] {\Huge{}37};
  % \draw[black!40] (0, 50) -- +(84.1, 0) node[midway, above, black!80] {\Huge{}50};
  ...
  \node[
    ...
    at (6.5, 8) {\textsf{\input{first_column_indentex}}};
  ...
  \node[
    ...
    at (47.5, 37) {\textsf{\input{second_column_indentex}}};
  ...
  \begin{scope}[xshift = 12 cm, yshift = -89.5 cm]
    \input{late_structure}
  \end{scope}


  % Footer -- author info, license
  \begin{scope}[xshift = 42.05 cm, yshift = -114.9 cm]
    \node[
      scale = 1.3,
